// Written by Ahamed Careem (Github profile: amcareem)
        ...
        try {
            ...
            if (username.matches("admin") && password.matches("admin123")) {
                ...
                while(true) {
                    ...
                    System.out.println("6. View Tender Details");
                    ...
                    } else if (number == 6) { // View Tender Details
                        try {
                            System.out.print("Enter the name of the Tender :");
                            String tenderName = sc.next();
                            if (tenderArray.containsKey(tenderName)) {
                                tenderArray.get(tenderName).printList();
                            } else {
                                System.out.println("Invalid Tender name");
                            }
                        } catch (Exception e) {
                            System.out.println("Error occurred");
                        }
